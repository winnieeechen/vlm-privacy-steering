...
def main():
    ...
    parser.add_argument("--steered-csv", default="outputs/steered_qwen_vl_val_layer32_alpha0.5.csv")
    parser.add_argument("--score-csv", default="outputs/condition_scores_qwen_vl_val_layer32.csv")
    parser.add_argument("--output-csv", default="outputs/conditional_sweep_val_layer32_alpha0.5.csv")
    args = parser.parse_args()

    base_rows = read_csv(ROOT / args.base_csv)
    steered_rows = read_csv(ROOT / args.steered_csv)
    ...
    print_metrics("Unconditional steered", metrics(steered_rows, "steered_pred_label", "steered_case_type"))
    ...
    for thr in thresholds:
        ...
        m = metrics(rows, "conditional_pred_label", "conditional_case_type")
        ...
        # prefer lower over-disclosure, but avoid too much under-disclosure;
        # among them, prefer higher correct.
        score_for_select = (
            -3.0 * m["over_rate"]
            -1.0 * m["under_rate"]
            +2.0 * m["correct_rate"]
    ...
    print_metrics("Best conditional", best_m)

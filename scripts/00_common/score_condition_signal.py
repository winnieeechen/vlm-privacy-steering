...
def main():
    ...
    parser.add_argument("--condition-vector", default="outputs/vectors/condition_vectors_qwen_vl_train.pt")
    parser.add_argument("--output-csv", default="outputs/condition_scores_qwen_vl_val_layer32.csv")

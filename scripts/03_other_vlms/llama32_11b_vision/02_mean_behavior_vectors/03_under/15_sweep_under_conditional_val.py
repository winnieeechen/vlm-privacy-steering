...
def main():
    ...
    parser.add_argument(
        "--under-csv",
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/03_under/val/"
            "under_steered_llama32_vision_val_layer32_alpha0.5.csv"
        ),
    )
    parser.add_argument(
        "--score-csv",
    ...
    parser.add_argument(
        ...
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/03_under/val/"
            "under_conditional_sweep_val_layer32_alpha0.5.csv"
        ),
    )
    ...
    for thr in thresholds:
        ...
        # Prefer lower under-disclosure, but penalize increased over-disclosure.
        score_for_select = (
            -3.0 * m["over_rate"]
            -2.0 * m["under_rate"]
            +2.0 * m["correct_rate"]

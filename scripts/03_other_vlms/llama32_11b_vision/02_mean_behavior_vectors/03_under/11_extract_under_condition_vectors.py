...
def main():
    ...
    payload = {
        ...
        "under_condition_vector": condition_vector,
        "under_condition_vector_unit": condition_vector_unit,
        "layer_norms": condition_vector.norm(dim=1),
        "definition": {
            "positive": "true_label B/C, location information allowed",
            "negative": "true_label A, abstention/refusal preferred",

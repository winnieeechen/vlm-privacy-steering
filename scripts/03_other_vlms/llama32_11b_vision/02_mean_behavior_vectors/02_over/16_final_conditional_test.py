...
def main():
    ...
    parser.add_argument(
        "--steered-csv",
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/02_over/test/"
            "steered_llama32_vision_test_layer24_alpha1.0.csv"
        ),
    )
    parser.add_argument(
        "--score-csv",
    ...
    parser.add_argument(
        ...
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/02_over/test/"
            "final_conditional_test_layer24_alpha1.0_thr0.04.csv"
        ),
    )

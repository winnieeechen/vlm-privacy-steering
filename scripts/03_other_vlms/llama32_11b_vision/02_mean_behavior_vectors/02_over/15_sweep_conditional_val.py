...
def main():
    ...
    parser.add_argument(
        "--steered-csv",
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/02_over/val/"
            "steered_llama32_vision_val_layer32_alpha0.5.csv"
        ),
    )
    parser.add_argument(
        "--score-csv",
    ...
    parser.add_argument(
        ...
        default=(
            "outputs/03_other_vlms/llama32_11b_vision/02_mean_behavior_vectors/02_over/val/"
            "conditional_sweep_val_layer32_alpha0.5.csv"
        ),
    )

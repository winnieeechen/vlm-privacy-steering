...
def paths_for_split(split):
    ...
    over_steered = ROOT / (
        f"outputs/03_other_vlms/llama32_11b_vision/02_over/{split}/"
        f"steered_llama32_vision_{split}_layer24_alpha1.0.csv"
    )
    under_steered = ROOT / (
        f"outputs/03_other_vlms/llama32_11b_vision/03_under/{split}/"
    ...
    out_dir = ROOT / f"outputs/03_other_vlms/llama32_11b_vision/04_combined_router/{split}"

...
def main():
    ...
    parser.add_argument(
        "--under-csv",
        default=(
            "outputs/03_other_vlms/qwen25_vl_7b_instruct/03_under/test/"
            "under_steered_qwen25_vl_7b_test_layer32_alpha0.5.csv"
        ),
    )
    parser.add_argument(
        "--score-csv",
    ...
    parser.add_argument(
        ...
        default=(
            "outputs/03_other_vlms/qwen25_vl_7b_instruct/03_under/test/"
            "final_under_conditional_test_layer32_alpha0.5_thr0.04.csv"
        ),
    )

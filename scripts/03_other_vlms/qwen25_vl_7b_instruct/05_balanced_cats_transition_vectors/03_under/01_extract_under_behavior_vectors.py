...
DEFAULTS = {
    ...
    "output": "outputs/03_other_vlms/qwen25_vl_7b_instruct/05_balanced_cats_transition_vectors/03_under/vectors/under_behavior_vectors_balanced_cats_train_717.pt",
    "reference_vector": "mean_delta",
    "reference_vector_key": "behavior_vector",
    "vector_key": "under_behavior_vector",
}

...
BASE_CSV = ROOT / "outputs/02_formal_full1200/02_over/base_qwen_vl_test_243.csv"

OVER_STEERED_CSV = ROOT / "outputs/02_formal_full1200/02_over/steered_qwen_vl_test_layer32_alpha0.5.csv"
UNDER_STEERED_CSV = ROOT / "outputs/02_formal_full1200/03_under/steered_under_qwen_vl_test_layer32_alpha0.5.csv"

OVER_SCORE_CSV = ROOT / "outputs/02_formal_full1200/02_over/condition_scores_test_layer32.csv"
UNDER_SCORE_CSV = ROOT / "outputs/02_formal_full1200/03_under/under_condition_scores_test_layer32.csv"

OUT_DIR = ROOT / "outputs/02_formal_full1200/04_combined_router/test"
...
def main():
    ...
    print("Combined cached routing on TEST")
    print("n =", n)
    ...
    for strategy in strategies:
        ...
        out_path = OUT_DIR / f"combined_test_{strategy}_layer32_alpha0.5.csv"
    ...
    summary_path = OUT_DIR / "combined_test_summary_layer32_alpha0.5.csv"

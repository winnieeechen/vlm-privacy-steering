...
CASE_CSV = ROOT / "outputs" / "original_logic_full1200_under" / "vector_cases" / "under_condition_vector_cases_train_717.csv"
OUT_PATH = ROOT / "outputs" / "original_logic_full1200_under" / "vectors" / "under_condition_vectors_full1200.pt"

...
BASE_CSV = ROOT / "outputs" / "original_logic_full1200" / "base_qwen_vl_train_717.csv"

UNDER_CONDITION_OUT = ROOT / "outputs" / "original_logic_full1200_under" / "vector_cases" / "under_condition_vector_cases_train_717.csv"
UNDER_BEHAVIOR_OUT = ROOT / "outputs" / "original_logic_full1200_under" / "vector_cases" / "under_behavior_vector_cases_train_717.csv"

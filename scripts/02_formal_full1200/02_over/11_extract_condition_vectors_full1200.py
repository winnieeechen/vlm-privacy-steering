...
CASE_CSV = ROOT / "outputs" / "original_logic_full1200" / "vector_cases" / "condition_vector_cases_train_717.csv"
OUT_PATH = ROOT / "outputs" / "original_logic_full1200" / "vectors" / "condition_vectors_full1200.pt"

...
CONDITION_OUT = ROOT / "outputs" / "original_logic_full1200" / "vector_cases" / "condition_vector_cases_train_717.csv"
BEHAVIOR_OUT = ROOT / "outputs" / "original_logic_full1200" / "vector_cases" / "behavior_vector_cases_train_717.csv"

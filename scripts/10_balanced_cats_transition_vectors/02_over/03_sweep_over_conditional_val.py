...
def main():
    ...
    delegate = ROOT / "scripts" / "10_balanced_cats_transition_vectors" / "00_common" / "sweep_conditional_cached.py"
    cmd = [
        sys.executable,
        str(delegate),
        "--base-csv",
        ...
        "--steered-csv",
        (
            "outputs/10_balanced_cats_transition_vectors/02_over/val/"

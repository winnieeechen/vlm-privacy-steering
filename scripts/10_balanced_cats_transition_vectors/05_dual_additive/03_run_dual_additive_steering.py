...
def main():
    ...
    cmd = [
        ...
        "outputs/10_balanced_cats_transition_vectors/02_over/vectors/behavior_vectors_balanced_cats_full1200.pt",
        "--under-behavior-vector",
        "outputs/10_balanced_cats_transition_vectors/03_under/vectors/under_behavior_vectors_balanced_cats_full1200.pt",
        "--over-score-csv",
        ...
        "--output-csv",
        (
            f"outputs/10_balanced_cats_transition_vectors/05_dual_additive/{args.split}/"
            f"dual_additive_balanced_cats_{args.split}_layer{args.layer}_"
